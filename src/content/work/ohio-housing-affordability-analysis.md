---
title: Ohio Housing Affordability Analysis
summary: An interactive Power BI dashboard analyzing housing affordability across Ohio counties (2019–2023) using U.S. Census ACS data.
problem: Where is housing becoming unaffordable across Ohio, and for whom?
methods:
  - Power BI
  - DAX
  - Mapping
...
links:
  - label: View the project on GitHub
    href: https://github.com/SARAH-GAKII/Ohio-Housing-Affordability-2019-2023-PowerBI-Project
---

## Overview

An interactive Power BI dashboard analyzing housing affordability across Ohio counties from 2019–2023, using U.S. Census American Community Survey (ACS) data. The project was motivated by volunteer experience with Habitat for Humanity, and it demonstrates how county-level data reveals affordability patterns that statewide averages hide.
...
- Ohio's average rent-to-income ratio remains moderate (roughly 15–16%), masking substantial county-level variation.
